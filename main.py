...
class SDGenerator(Star):
    ...
    async def show_conf(self, event: AstrMessageEvent):
        ...
        try:
            promot_group = self.config["promot_group"]  # 获取提示词组配置
            positive_promot_group = promot_group["positive_promot_group"]   # 获取正面提示词组
            negative_promot_group = promot_group["negative_promot_group"]   # 获取负面提示词组
            ...
            positive_prompt1 = positive_promot_group["positive_prompt1"] or "无法读取"   # 获取正面提示词1
            negative_prompt1 = negative_promot_group["negative_prompt1"] or "无法读取"  # 获取负面提示词1
